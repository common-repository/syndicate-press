...
LICENSE:
============
Copyright (c) 2009-2018 Henry Ranch LLC. All rights reserved. http://syndicatepress.henryranch.net/
...
YOU MAY REQUEST A LICENSE TO DO SO FROM THE AUTHOR.
 ...
 Copyright 2009-2018  HenryRanch LLC  
...
if (!class_exists("SyndicatePressPlugin")) {
  class SyndicatePressPlugin {
        ...
        function sp_filterCallback($bbCodeTagArray)
        {
            ...
            $pageFeedReferenceArray = explode(" ", $pageFeedReference);
